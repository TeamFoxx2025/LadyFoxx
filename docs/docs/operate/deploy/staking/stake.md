...
Each validator needs to perform initial staking on the rootchain `StakeManager` contract. This is done using the `foxx-chain root stake` command. **Note that this command is for testing purposes only.**
...
```bash
   ./foxx-chain polybft supernet --private-key 0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef \
