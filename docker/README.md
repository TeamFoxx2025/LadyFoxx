...
Running `foxx-chain` local cluster with docker can be done very easily by using provided `scripts` folder
...
Use `docker/local/foxx-chain.sh` script to customize chain parameters.
...
These are the `genesis` parameters from the official [docs](https://wiki.foxx-chain.technology/docs/edge/operate/param-reference/).  
...
For production usage, please check out the official [docs](https://wiki.foxx-chain.technology/docs/edge/).
